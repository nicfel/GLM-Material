...
%%
system('rm -r xmls/newmascot');
system('mkdir xmls/newmascot');
...
for utn = 1 : 10
    ...
    for tr = 1 : 1    
        ...
        fname = sprintf('xmls/newmascot/%s.xml',flog);
        g = fopen(fname,'w');
...
%         fprintf(g,'\t\t</operator>\n');
        ...
        fprintf(g,'\t\t<operator id="MigrationScalerScaler" spec="beast.mascot.operators.RealRandomWalkOperator" windowSizeOn="0.02" windowSizeOff="0.5" indicator="@migrationIndicator" parameter="@migrationScaler" useGaussian="true" weight="20.0"/>\n');
        
		fprintf(g,'\t\t<operator id="indicatorFlip.s:Migration" spec="BitFlipOperator" parameter="@migrationIndicator" weight="50"/>\n');
