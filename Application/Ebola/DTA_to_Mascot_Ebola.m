...
%         fprintf(g,'\t\t<operator id="KappaScaler.s" spec="ScaleOperator" parameter="@kappa.s" scaleFactor="0.5" weight="1"/>\n');
        ...
        fprintf(g,'\t\t<operator id="Narrow.t" spec="Exchange" tree="@tree" weight="10.0"/>\n');
        fprintf(g,'\t\t<operator id="Wide.t" spec="Exchange" tree="@tree" isNarrow="false" weight="10.0"/>\n');
        fprintf(g,'\t\t<operator id="WilsonBalding.t" spec="WilsonBalding" tree="@tree" weight="3.0"/>\n');
        fprintf(g,'\t\t<operator id="NeMigUpDownOperator.t" spec="UpDownOperator" scaleFactor="0.98" weight="1.5">\n');
		...
		fprintf(g,'\t\t<operator id="NeScalerScaler" spec="beast.mascot.operators.RealRandomWalkOperator" windowSizeOn="0.02" windowSizeOff="0.5" indicator="@NeIndicator" parameter="@NeScaler" useGaussian="true" weight="30.0"/>\n');
        fprintf(g,'\t\t<operator id="MigrationScalerScaler" spec="beast.mascot.operators.RealRandomWalkOperator" windowSizeOn="0.02" windowSizeOff="0.5" indicator="@migrationIndicator" parameter="@migrationScaler" useGaussian="true" weight="30.0"/>\n');
